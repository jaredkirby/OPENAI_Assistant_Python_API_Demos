...
class OAI_Assistant:
    def __init__(self, api_key, organization, timeout=None, log_level=logging.INFO):
        ...
        self.logger.debug(f"Initialized AssistantManager. self.client: {self.client}")
    ...
    def change_thread(
        self, thread_name: str or None = None, thread_id: str or None = None  # type: ignore
    ) -> int:
        """
        ...
        Returns:
            int: thread_id if the thread was changed successfully, -1 otherwise.
        """
        ...
        if thread_name is not None:
            ...
            if thread_name in threads:
                ...
                self.logger.debug(
                    f"Thread {thread_name} not found. Creating new thread..."
                )
                # create a new thread
            ...
            return thread_id
        # Return -1 if neither thread_name nor thread_id led to a valid return earlier
        return -1
    ...
    def save_tool_metadata(
        self, tool_name, tool_required, tool_description, tool_schema
    ):
        """
    ...
    def make_tool_metadata(
        self, tool_name, tool_required, tool_description, tool_properties
    ):
        """
    ...
    def enable_tools(self, assistant_id, tools_list):
        ...
        assistant = self.modify_assistant(
    ...
    def create_assistant(
        self, model, instructions, name=None, tools=None, file_ids=None, metadata=None
    ):
        """
